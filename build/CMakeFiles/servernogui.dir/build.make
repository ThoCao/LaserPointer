...
servernogui: /usr/local/lib/libopencv_dnn.so.4.1.2
servernogui: /usr/local/lib/libopencv_gapi.so.4.1.2
servernogui: /usr/local/lib/libopencv_highgui.so.4.1.2
servernogui: /usr/local/lib/libopencv_ml.so.4.1.2
servernogui: /usr/local/lib/libopencv_objdetect.so.4.1.2
servernogui: /usr/local/lib/libopencv_photo.so.4.1.2
servernogui: /usr/local/lib/libopencv_stitching.so.4.1.2
servernogui: /usr/local/lib/libopencv_video.so.4.1.2
servernogui: /usr/local/lib/libopencv_videoio.so.4.1.2
servernogui: /usr/lib/arm-linux-gnueabihf/libQt5Gui.so.5.11.3
servernogui: /usr/lib/arm-linux-gnueabihf/libQt5Core.so.5.11.3
servernogui: /usr/local/lib/libopencv_imgcodecs.so.4.1.2
servernogui: /usr/local/lib/libopencv_calib3d.so.4.1.2
servernogui: /usr/local/lib/libopencv_features2d.so.4.1.2
servernogui: /usr/local/lib/libopencv_flann.so.4.1.2
servernogui: /usr/local/lib/libopencv_imgproc.so.4.1.2
servernogui: /usr/local/lib/libopencv_core.so.4.1.2
